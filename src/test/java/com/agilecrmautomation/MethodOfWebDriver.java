...
public class MethodOfWebDriver extends BaseClass {
	...
	public static void main(String[] args) throws AWTException {
		 ...
		 * 
		 * element.clear(); element.sendKeys("Vijay"); WebElement element1 =
		 * driver.findElement(By.xpath("//input[@placeholder='Last Name']"));
		 * element1.clear(); element1.sendKeys("Korsegaonkar"); WebElement element2 =
		 * driver.findElement(By.xpath("//input[@type='email']")); element2.clear();
		 * element2.sendKeys("vlorsegaonkar@gmail.com"); WebElement element3 =
		 * driver.findElement(By.xpath("//input[@type='tel']")); element3.clear();
		 * element3.sendKeys("7798266143"); WebElement element4 =
		 * driver.findElement(By.xpath("//input[@value='Male']")); element4.click();
		 * driver.findElement(By.id("checkbox1")).click();
		 * driver.findElement(By.id("checkbox3")).click(); WebElement language =
		 * driver.findElement(By.id("msdd"));
		 * 
		 * language.sendKeys("English"); WebElement skill =
		 * (driver.findElement(By.xpath("//select[@id='Skills']"))); skill.click();
		 * 
		 * // List<WebElement> //
		 * checkbox=driver.findElements(By.xpath("//input[@type='radio']"));
		 * 
		 * driver.findElement(By.xpath("//span[@role='combobox']")).click(); Robot robot
		 * = new Robot(); robot.mousePress(InputEvent.BUTTON2_DOWN_MASK);
		 * robot.keyPress(KeyEvent.VK_ENTER);
		 * robot.mouseRelease(InputEvent.BUTTON2_DOWN_MASK);
		 * 
		 * // Select year=new Select(driver.findElement(By.id("yearbox"))); //
		 * year.selectByVisibleText("1992"); // Select day=new
		 * Select(driver.findElement(By.id("daybox"))); //
